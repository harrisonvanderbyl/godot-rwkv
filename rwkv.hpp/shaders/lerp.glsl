...
layout( constant_id = 2 ) const uint IN = 1;

layout(set = 0, binding = 0) readonly buffer l_buffer {
    float xy[];
};

layout(set = 0, binding = 1) readonly buffer a_buffer {
    float a[];
};
